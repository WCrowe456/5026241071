...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <a class="btn-getstarted" href="visitstore.bio/dell?tab=ig">Mulai Belanja</a>
                        ...
                        <div class="d-flex">
                            ...
                            <a href="visitstore.bio/dell?tab=ig"
                                class="glightbox btn-watch-video d-flex align-items-center"><i
                                    class="bi"></i><span>Mulai Belanja</span></a>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                        <p>
                            We are a global team united under a single purpose: to drive human progress through the
                            power of technology.
                        </p>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-5 order-1 order-lg-2 why-us-img">
                        <img src="https://i.dell.com/is/image/DellContent/content/dam/ss2/page-specific/dell-com-landing-page/view-all-services/shutterstock-1212195550-1400x932.png?fmt=jpg&wid=1400&hei=932" class="img-fluid" alt="" data-aos="zoom-in"
                            data-aos-delay="100">
                    </div>
                </div>
